...
import '../riderapp/pickdrop3.dart';
...
class _MainScreenState extends State<MainScreen> {
                      ...
                      Align(
                        ...
                        child: Container(
                          child: ElevatedButton(
                            onPressed: () {
                              final pickup = placeAddress;
                              createRide(pickup: pickup);
  ...
  Future<void> getPlaceDirection() async {
    ...
    final cost = AssistantMethods.calculateFares(details);
    final distance = details.distanceValue;
    createRide1(cost: cost, distance: distance);
  ...
  Future createRide({required String pickup}) async {
    final docride =
  ...
  Future createRide1({required int cost, required int distance}) async {
    final docride =
        FirebaseFirestore.instance.collection("History").doc("${docid}");
    final json = {
      "Cost": cost,

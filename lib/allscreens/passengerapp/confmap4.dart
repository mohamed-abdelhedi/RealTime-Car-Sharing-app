...
import 'package:flutter_application_1/allscreens/passengerapp/requestCar5.dart';
import 'package:geolocator/geolocator.dart';
import 'package:flutter/material.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import '../riderapp/addcom4.dart';
...
class _MainScreenState extends State<MainScreen2> {
  ...
  void _navigateToNextScreen(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => MainScreen5()));
  }
}

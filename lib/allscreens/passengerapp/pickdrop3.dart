...
import 'package:flutter_application_1/allscreens/passengerapp/confmap4.dart';
...
class _AbcdWidgetState extends State<AbcdWidget> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          (pickdrop2.placePredictionList.isNotEmpty)
              ? Align(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return PredictionTile(
                          placePredictions:
                              pickdrop2.placePredictionList[index],
                        );
                      },
                      separatorBuilder: (BuildContext context, int index) =>
                          DividerWidget(),
                      itemCount: pickdrop2.placePredictionList.length,
                      shrinkWrap: true,
  ...
  void findPlace(String placeName) async {
    if (placeName.length > 0) {
      ...
      setState(() {
        pickdrop2.placePredictionList = placeslist;
        print("prediction list : ");
        print(pickdrop2.placePredictionList);
      });
    }
  }
